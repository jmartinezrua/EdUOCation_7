...
public class EdUOCationControllerTest {
    ...
    void testAddEnrollment() {
        ...
        List<String> enrollmentsGroupA = controller.getEnrollments("98765432B");
        List<String> enrollmentsGroupB = controller.getEnrollments("65432109E");
    ...
    void testUpdateEnrollmentMark() {
        boolean updatedMarkFalse1 = controller.updateEnrollmentMark("Algorithms and Data Structures", "2023A", "98765432B", -0.1);
        boolean updatedMarkFalse2 = controller.updateEnrollmentMark("Algorithms and Data Structures", "2023A", "98765432B", 10.1);

        assertFalse(updatedMarkFalse1);
        assertFalse(updatedMarkFalse2);

        boolean updatedMark1 = controller.updateEnrollmentMark("Algorithms and Data Structures", "2023A", "98765432B", 9.5);
        boolean updatedMark2 = controller.updateEnrollmentMark("Organic Chemistry", "2023B", "76543210D", 8.0);
    ...
    void testGetEnrollments() {
        List<String> enrollmentsGroupA = controller.getEnrollments("98765432B");
        List<String> enrollmentsGroupF = controller.getEnrollments("32109876H");
